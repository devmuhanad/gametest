...
const CACHE_NAME = "DD-cache";
const OFFLINE_URL = "DD.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["DD.html","DD.js","DD.wasm","DD.pck","DD.offline.html","DD.icon.png","DD.apple-touch-icon.png"];
